            ...
            <div className="absolute top-0 left-1/4 sm:left-1/2 w-3/4 sm:w-1/2 h-full flex center ">
                <div className="w-fit h-fit bg-white_coffee rounded-3xl flex flex-col items-center p-2 sm:p-4  gap-1 sm:gap-2 mr-[5%] " >
                    ...
                    <div className="flex flex-row w-[90%] mb-[2px] sm:mb-[4px] ">
                        ...
                        <div className="w-[30%]"><div className="w-full ml-[10px] p-1 sm:p-4 flex center border-2 rounded-xl bg-blue text-white text-[5px] sm:text-[10px] 3xl:text-[14px] font-mt-bold " onClick={()=>createUser(value)}> {dictionnaire.B2B.contact}</div></div>
                    </div>
                </div>    
            </div>
        </div>
                        ...
                        <div className="w-full h-full relative flex flex-col">
                            ...
                            <div className="flex flex-col center h-[calc(100%-300px)] text-[6px] sm:text-[14px] 3xl:text-[16px] mt-[60px] sm:m">
                                <div>
                                    ...
                                    <div className="flex text-left 3xl:mt-[26px]"><img src={"/images/check.png"} alt={"check"} className="w-2 h-2 sm:w-fit sm:h-fit"/>{dictionnaire.B2B.expert.expert3}</div>
                                    <div className="flex text-left"><img src={"/images/check.png"} alt={"check"} className="w-2 h-2 sm:w-fit sm:h-fit"/>{dictionnaire.B2B.expert.expert4}</div>
                                    <div className="flex text-left"><img src={"/images/check.png"} alt={"check"} className="w-2 h-2 sm:w-fit sm:h-fit"/>{dictionnaire.B2B.expert.expert5}</div>
                                    <div className="flex text-left"><img src={"/images/check.png"} alt={"check"} className="w-2 h-2 sm:w-fit sm:h-fit"/>{dictionnaire.B2B.expert.expert6}</div>
                                    <div className="flex text-left"><img src={"/images/check.png"} alt={"check"} className="w-2 h-2 sm:w-fit sm:h-fit"/>{dictionnaire.B2B.expert.expert7}</div>
                                    <div className="flex text-left"><img src={"/images/check.png"} alt={"check"} className="w-2 h-2 sm:w-fit sm:h-fit"/>{dictionnaire.B2B.expert.expert8}</div>        
                                </div>
                            </div>
