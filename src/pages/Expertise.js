...
const Expertise = ()=>{
    ...
    return (<>
        ...
        <Layout2image props={{col1:switchtext("Expertise1"),image1:{url:"/images/visage/visage26.png",alt:"visage26",className:"w-[80%] bg-[#264C4D]"},col2:switchtext("Expertise2"),image2:{url:"/images/visage/visage27.png",alt:"visage27",className:"w-[80%] bg-[#264C4D]"},col3:switchtext("Expertise3"),image3:{url:"/images/visage/visage28.png",alt:"visage28",className:"w-[80%] bg-[#264C4D]"}}}/>
