...
//     <div className="w-full text-center text-[50px]  mt-[50px] font-mt-extra-bold text-blue">Nos conseils</div>
...
//     <div className="w-full text-left text-[50px] mt-[20px] ml-[155px] font-mt-extra-bold text-blue">Les derniers tutos...</div>
//     <Carousel2 props={{items:listCarousel2,nbShow:3,ratio:10,showPoint:false,disableClic:true}}/>

//     <div className="relative w-full h-0.5 mt-[100px] mb-[100px] bg-[#10264C4D]"></div>

//     <div className="w-full text-left text-[50px] mt-[20px] ml-[165px] font-mt-extra-bold text-blue">Catégories</div>
//     <Carousel2 props={{items:listCarousel3,nbShow:3,ratio:10,showPoint:false,disableClic:true}}/>

//     <div className="relative w-full h-0.5 mt-[100px] mb-[100px] bg-[#10264C4D]"></div>

//     <div className="w-full text-left text-[50px] mt-[20px] ml-[155px] font-mt-extra-bold text-blue">Interviews</div>
