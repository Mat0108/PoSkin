...
const LayoutFullImage =({props})=>{
    return (<>
        <div className="relative w-full h-fit bg-[#DEE4E4]">
            ...
            <div className="absolute z-[100]  top-[24%] sm:top-[30%] w-full h-[30px] text-white_coffee font-mt-extra-bold text-[18px] sm:text-[70px] flex center"><p className="">{props.titre}</p></div>
