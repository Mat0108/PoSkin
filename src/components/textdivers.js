...
const produittitre = ()=>{
  return(<>
    <div className="row-start-1 flex flex-col center">
      <p className="text-blue text-[50px] font-mt-bold">Les iconiques</p>
...
const produitcol1 = ()=>{
  return(<>
  <p className="mx-auto mt-[35px] w-[350px] text-[30px] font-mt-bold text-blue text-left">Sérum Yeux</p>
  ...
  <div className="w-[270px] mt-[30px] flex flex-row center">
      ...
      <div className="text-[20px] w-fit px-4 py-2 bg-[#83C5BE] rounded-3xl font-mt-bold text-[#264C4D] text-left hover:text-white hover:bg-blue"><p>Je découvre</p></div>    
  </div>
  </>)
}
...
const produitcol2 = ()=>{
  return (<>
  <p className="mx-auto mt-[35px] w-[350px] text-[30px] font-mt-bold text-blue text-left">Assemblage botanique </p>
  <p className="mx-auto text-[30px] w-[350px] font-mt-bold text-blue text-left">tenseurau nopal</p>
...
const produitcol3 = () =>{
  return (<>
  <p className="mx-auto mt-[35px] w-[350px] text-[30px] font-mt-bold text-blue text-left">Gel nettoyant exfoliant</p>
...
const quisommesnous = () =>{
  return (<>
    ...
    <p className="text-[50px] font-mt-bold text-blue text-left w-[50%] mt-[4%] ">Notre histoire</p>
    <p className="text-[50px] font-mt-bold text-blue text-left w-[50%]">et votre histoire</p>
  ...
  <div className="absolute bottom-0 left-0 w-full"><div className="w-[70%]  flex center"><div className="ml-[10px] text-[30px] w-fit px-6 py-2 bg-[#83C5BE] rounded-full font-mt-bold text-[#264C4D] text-left hover:text-white hover:bg-blue"><p>En savoir plus</p></div></div>   
  </div>
  </>)
}
const quisommesnous2 = () =>{
  return (<>
    <p className="text-[50px] font-mt-bold text-blue text-center w-full">NOTRE CONCEPT & NOTRE TEAM</p>
      
  </>)
}
const quisommesnous3 = () =>{
  return (<div className="w-[450px]">
    <p className="mt-[32px] mb-[32px] text-[24px] font-mt-bold text-blue text-center w-full">CONCEPT</p>
    <div className=""><p className="mt-[32px] mb-[32px] text-[16px] font-mt-bold text-blue text-center w-full">Po. est bien plus qu'une simple application de soins de la peau, c'est une véritable solution complète pour vous accompagner dans votre parcours de beauté. Avec Po, vous avez accès à une multitude d'outils et de ressources pour prendre soin de votre peau de manière personnalisée et efficace.</p>
    </div>
...
const NotreHistoire = ()=>{
  return <div className="w-[90%]">
      <p className="text-[50px] font-mt-bold text-left ">Nos experts</p>
...
return <div className="w-[90%]">
      <p className="text-[50px] font-mt-bold text-left ">Une expertise, une passion</p>
...
const EcoleDelphine = ()=>{
  return <div className="w-[80%] ml-[30px]">
      <p className="text-[40px] font-mt-bold text-left ">École Delphine Langlois - </p>
      <p className="text-[40px] font-mt-bold text-left ">Facialiste Paris</p>
      ...
      <div className="flex center"><div className="mt-[20px] text-[30px] w-fit px-8 py-4 bg-[#83C5BE] rounded-full font-mt-bold text-blue text-left hover:text-white hover:bg-blue"><p>En savoir plus</p></div>
      </div>
  </div>
}
...
const Commu1 = ()=>{
  return <>
  <div className="font-mt-bold text-[28px]">
...
const Expertise1 = ()=>{
  return<div className="w-full flex flex-col center">
   <p className="text-[30px] bg-[#264C4D] font-mt-bold text-center text-white w-[312px] p-2">Personnalisé</p>
   <p className="text-[16px] bg-[#264C4D] font-mt-bold text-justify  text-white w-[312px] h-[280px] px-4 pb-10">Chez Po, nous comprenons que chaque peau est unique. C'est pourquoi nous vous offrons des recommandations personnalisées en fonction de votre type de peau, de vos préoccupations et de vos objectifs. Notre approche sur mesure vous permet d'obtenir les meilleurs résultats pour votre peau.</p>
   
  </div>
}
const Expertise2 = ()=>{
  return<div className="w-full flex flex-col center">
   <p className="text-[30px] bg-[#264C4D] font-mt-bold text-center text-white w-[312px] p-2">Accompagnement</p>
...
const Expertise3 = ()=>{
  return<div className="w-full flex flex-col center">
   <p className="text-[30px] bg-[#264C4D] font-mt-bold text-center text-white w-[312px] p-2">Suivi</p>
...
const ConseilCarousel1Image1 = () =>{
  return (<>
  <p className="mt-[20px] text-[25px] font-mt-bold text-blue">Vitamine C pour la peau : les bienfaits</p>    
...
const ConseilCarousel2Image1 = () =>{
  return (<>
  <p className="mt-[20px] text-[25px] font-mt-bold text-blue">Choisissez la bonne skincare</p>    
...
const ConseilCarousel2Image2 = () =>{
  return (<>
  <p className="mt-[20px] text-[25px] font-mt-bold text-blue">Prenez soin de vos cheveux</p>    
...
const ConseilCarousel2Image3 = () =>{
  return (<>
  <p className="mt-[20px] text-[25px] font-mt-bold text-blue">5 min maquillage idéale</p>    
...
const ConseilCarousel4Image1 = () =>{
  return (<div className="w-full flex center">
    <div className="w-[70%]">  
      <p className="mt-[20px] text-[25px] font-mt-bold text-blue">Marie ROBERT</p>    
...
const ConseilCarousel4Image2 = () =>{
  return (<div className="w-full flex center">
  <div className="w-[70%]">
      <p className="mt-[20px] text-[25px] font-mt-bold text-blue">Dr Agathe AOUN</p>    
...
const ConseilCarousel4Image3 = () =>{
  return (<div className="w-full flex center">
  <div className="w-[70%]">
    <p className="mt-[20px] text-[25px] font-mt-bold text-blue">Augustinus Bader</p>    
