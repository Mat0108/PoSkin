            ...
            <div className="sm:col-start-2 col-span-3">
                ...
                <div className="w-[100%] mt-[15px] sm:mt-[80px] grid grid-cols-2 ">
                    <div className="col-start-1 flex flex-col items-center">
                        ...
                        <div className="mt-[5px] sm:mt-[20px] p-4 flex center"> <img src={"./images/partenaire1.png"} alt={"partenaire1"}  className="w-2/3 sm:w-fit "/></div>  
                    </div>
                    <div className="col-start-2 flex flex-col items-center ">
                        <p className="text-white text-[6px] sm:text-[16px] w-[90%] sm:w-[60%] ">{dictionnaire.Expertise.ecole}</p>
                        <div className="mt-[5px] sm:mt-[20px] p-4 flex center"> <img src={"./images/partenaire2.png"}  alt={"partenaire2"} className="w-2/3 sm:w-fit "/></div>  
                    </div>
