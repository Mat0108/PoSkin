...
const Newsletter =()=>{
    ...
    return (<>
        ...
        <div className="relative w-full h-[100px] sm:h-[260px] grid grid-cols-5 bg-[#83C5BE]">
            <div className="col-start-1 col-span-2 flex flex-col text-center my-auto ml-[40px]">
                ...
                <p className="w-[90%] sm:w-[60%] text-[7px] sm:text-[14px] text-justify">Suivez notre actualité et ne manquez aucune de nos nouveautés en vous inscrivant à notre newsletter </p>
            </div>
            <div className="col-start-3 col-span-3 flex flex-col center ">
                <p className="text-[12px] sm:text-[30px] ">Votre adresse mail:</p>
                <div className="flex flex-row w-[90%]">
                    <input className="w-[80%] bg-[#83C5BE] border-b-2 mt-5 text-[10px] sm:text-[18px]" placeholder="votre mail " value={value} onChange={e=>setValue(e.target.value)}></input>
